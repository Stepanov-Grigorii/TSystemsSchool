...
<div class="container">
    <div class="row mt-3">
        <div class="col">
            <c:url value="/admin/orders/save2?id=${orderDTO.cargoId}" var="savelink"/>
            <form:form method="post" action="${savelink}" autocomplete="false" modelAttribute="orderDTO">
                ...
                <div class="mb-3">
                    ...
                    <form:select path="wagonId" items="${orderDTO.wagonDtoList}" itemLabel="registryNumber"
                                 itemValue="id" multiple="false" class="form-select"/>

                </div>
                <div class="mb-3">
                    <form:label path="waypointId" class="form-label">Пункт назначения:</form:label>
                    <form:select path="waypointId" items="${orderDTO.waypointDtoList}" itemLabel="name" itemValue="id"
                                 multiple="false" class="form-select"/>
